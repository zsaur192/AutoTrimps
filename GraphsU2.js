...
function safeSetItems2(name,data) {
    try {
      ...
      if (e.code == 22) {
        ...
        debug2("Error: LocalStorage is full, or error. Attempt to delete some portals from your graph2 or restart browser.");
      }
    }
}
...
function pushData2() {
    debug2('Starting Zone ' + game.global.world, "graph2s");
