...
function addDarkGraphs2(){var a=document.getElementById("dark-graph.css");if(!a){var b=document.createElement("link");b.rel="stylesheet",b.type="text/css",b.id="dark-graph.css",b.href=basepath+"dark-graph.css",document.head2.appendChild(b),debug2("Adding dark-graph.css file","graph2s")}}
function removeDarkGraphs2(){var a=document.getElementById("dark-graph.css");a&&(document.head2.removeChild(a),debug2("Removing dark-graph.css file","graph2s"))}
