...
function autoStance3() {
      ...
      if (((getPageSetting('WindStackingMin') >= 1 && game.global.challengeActive != "Daily") || (getPageSetting('dWindStackingMin') >= 1 && game.global.challengeActive == "Daily")) && (getEmpowerment() != "Wind" || game.global.mapsActive || game.empowerments.Wind.currentDebuffPower >= windstackmax || windstackzone < 0 || windstackzone >= game.global.world || game.global.spireActive || getPageSetting('windhealthy') == true && !ishealthy && game.global.challengeActive != "Daily" || getPageSetting('dwindhealthy') == true && !ishealthy && game.global.challengeActive == "Daily")) {
