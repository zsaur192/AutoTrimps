...
var use_scry = game.global.preMapsActive || game.global.gridArray.length === 0 || game.global.highestLevelCleared < 180;
    ...
    use_scry = use_scry || (getPageSetting('ScryerSkipBoss2') == 1 && game.global.world < getPageSetting('VoidMaps') && game.global.lastClearedCell < 99) || (getPageSetting('ScryerSkipBoss2') == 0 && game.global.lastClearedCell < 99);
