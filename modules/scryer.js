...
if (getPageSetting('UseScryerStance') == true && (valid_min && valid_max && !(getPageSetting('onlyminmaxworld') == true || (getCurrentMapCell()["name"] == "Chronoimp" || getCurrentMapCell()["name"] == "Jestimp")) && game.global.mapsActive)) {
    if (oktoswitch)
    setFormation(4);
    wantToScry = true;
    }
