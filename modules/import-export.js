...
function ImportExportTooltip(what, event) {
    ...
    if (what == "ExportAutoTrimps") {
        ...
        function c2listcolor(){function a(b,c,d){var e=100*(game.c2[b]/game.global.highestLevelCleared);c2list[b].color=e>=c?"LIMEGREEN":e<c&&e>=d?"GOLD":e<d&&1<=e?"#de0000":"DEEPSKYBLUE"}Object.keys(c2list).forEach(function(b){null!=game.c2[b]&&("Coordinate"===b?a(b,50,42):"Trimp"===b?a(b,45,35):"Obliterated"===b?a(b,25,20):"Mapology"===b?a(b,90,80):"Trapper"===b?a(b,85,75):a(b,95,85))})}
        c2listcolor();
