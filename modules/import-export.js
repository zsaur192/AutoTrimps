...
function ImportExportTooltip(what, event) {
    ...
    if (what == "ExportAutoTrimps") {
        ...
        function c2listcolor(){function a(b,c,d){var e=100*(game.c2[b]/game.global.highestLevelCleared);c2list[b].color=e>=c?"green":e<c&&e>=d?"yellow":e<d&&1<=e?"red":"blue"}Object.keys(c2list).forEach(function(b){null!=game.c2[b]&&("Coordinate"===b?a(b,50,42):"Trimp"===b?a(b,45,35):"Obliterated"===b?a(b,25,20):"Mapology"===b?a(b,90,80):"Trapper"===b?a(b,85,75):a(b,95,85))})}
        c2listcolor();
