...
function ImportExportTooltip(what, event) {
    ...
    if (what == "ExportAutoTrimps") {
        ...
        tooltipText = "<table class='bdTableSm table table-striped'><tbody><tr><td>Name</td><td>Difficulty</td><td>%C2</td><td>Zone</td><td>%HZE</td></tr><tr><td>Size</td><td>" + c2list.Size.number + "</td><td>" + c2list.Size.percent + "</td><td>" + c2list.Size.zone + "</td><td><font color=" + c2list.Size.color + ">" + c2list.Size.percentzone + "</td></tr><tr><td>Slow</td><td>" + c2list.Slow.number + "</td><td>" + c2list.Slow.percent + "</td><td>" + c2list.Slow.zone + "</td><td>" + c2list.Slow.percentzone + "</td></tr><tr><td>Watch</td><td>" + c2list.Watch.number + "</td><td>" + c2list.Watch.percent + "</td><td>" + c2list.Watch.zone + "</td><td>" + c2list.Watch.percentzone + "</td></tr><tr><td>Discipline</td><td>" + c2list.Discipline.number + "</td><td>" + c2list.Discipline.percent + "</td><td>" + c2list.Discipline.zone + "</td><td>" + c2list.Discipline.percentzone + "</td></tr><tr><td>Balance</td><td>" + c2list.Balance.number + "</td><td>" + c2list.Balance.percent + "</td><td>" + c2list.Balance.zone + "</td><td>" + c2list.Balance.percentzone + "</td></tr><tr><td>Meditate</td><td>" + c2list.Meditate.number + "</td><td>" + c2list.Meditate.percent + "</td><td>" + c2list.Meditate.zone + "</td><td>" + c2list.Meditate.percentzone + "</td></tr><tr><td>Metal</td><td>" + c2list.Metal.number + "</td><td>" + c2list.Metal.percent + "</td><td>" + c2list.Metal.zone + "</td><td>" + c2list.Metal.percentzone + "</td></tr><tr><td>Lead</td><td>" + c2list.Lead.number + "</td><td>" + c2list.Lead.percent + "</td><td>" + c2list.Lead.zone + "</td><td>" + c2list.Lead.percentzone + "</td></tr><tr><td>Nom</td><td>" + c2list.Nom.number + "</td><td>" + c2list.Nom.percent + "</td><td>" + c2list.Nom.zone + "</td><td>" + c2list.Nom.percentzone + "</td></tr><tr><td>Electricity</td><td>" + c2list.Electricity.number + "</td><td>" + c2list.Electricity.percent + "</td><td>" + c2list.Electricity.zone + "</td><td>" + c2list.Electricity.percentzone + "</td></tr><tr><td>Toxicity</td><td>" + c2list.Toxicity.number + "</td><td>" + c2list.Toxicity.percent + "</td><td>" + c2list.Toxicity.zone + "</td><td>" + c2list.Toxicity.percentzone + "</td></tr><tr><td>Coordinate</td><td>" + c2list.Coordinate.number + "</td><td>" + c2list.Coordinate.percent + "</td><td>" + c2list.Coordinate.zone + "</td><td>" + c2list.Coordinate.percentzone + "</td></tr><tr><td>Trimp</td><td>" + c2list.Trimp.number + "</td><td>" + c2list.Trimp.percent + "</td><td>" + c2list.Trimp.zone + "</td><td>" + c2list.Trimp.percentzone + "</td></tr><tr><td>Obliterated</td><td>" + c2list.Obliterated.number + "</td><td>" + c2list.Obliterated.percent + "</td><td>" + c2list.Obliterated.zone + "</td><td>" + c2list.Obliterated.percentzone + "</td></tr><tr><td>Mapology</td><td>" + c2list.Mapology.number + "</td><td>" + c2list.Mapology.percent + "</td><td>" + c2list.Mapology.zone + "</td><td>" + c2list.Mapology.percentzone + "</td></tr><tr><td>Trapper</td><td>" + c2list.Trapper.number + "</td><td>" + c2list.Trapper.percent + "</td><td>" + c2list.Trapper.zone + "</td><td>" + c2list.Trapper.percentzone + "</td></tr>    </tbody></table>";
