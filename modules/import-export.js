...
function ImportExportTooltip(what, event) {
    ...
    if (what == "ExportAutoTrimps") {
        ...
        function c2listcolor(){function f(g,h,i){var j=100*(game.c2[g]/game.global.highestLevelCleared);c2list[g].color=j>=h?"green":j<h&&j>=i?"yellow":j<i&&1>j?"red":"blue"}Object.keys(c2list).forEach(function(g){null!=game.c2[g]&&("Coordinate"===g?f(g,50,42):"Trimp"===g?f(g,45,35):"Obliterated"===g?f(g,25,20):"Mapology"===g?f(g,90,80):"Trapper"===g?f(g,85,75):f(g,95,85))})}c2listcolor();
