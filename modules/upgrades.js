...
function buyUpgrades() {
    for (var upgrade in upgradeList) {
        ...
        if (upgrade == 'Coordination' && getPageSetting('amalcoord')==true && getPageSetting('amalcoordt') < 0 && getPageSetting('amalcoordhd') > 0 && HDratioy() < getPageSetting('amalcoordhd')) continue;
        if (upgrade == 'Coordination' && getPageSetting('amalcoord')==true && getPageSetting('amalcoordhd') > 0 && getPageSetting('amalcoordt') > 0 && HDratioy() < getPageSetting('amalcoordhd') && getPageSetting('amalcoordt') > game.jobs.Amalgamator.owned && (game.resources.trimps.realMax() / game.resources.trimps.getCurrentSend()) < 2000) continue;
