var ATversion='ZekBETA v4.5.0',atscript=document.getElementById('AutoTrimps-script'),basepath='https://Zsaur192.github.io/AutoTrimps/',modulepath='modules/';null!==atscript&&(basepath=atscript.src.replace(/AutoTrimps2\.js$/,''));
...
function mainLoop() {
	...
	if (game.stats.highestRadLevel.valueTotal() >= 75 && getPageSetting('RAB') == true) {
            ...
            if (getPageSetting('RABfarm') == true) ABfarmswitch();
	}
