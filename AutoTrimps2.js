...
var changelogList = [];
changelogList.push({date: "16/08/2018", version: "v2.5.3", description: "New Magma settings overhaul, it should be easier to understand now. Please let me know if something doesn\'t work with it. There\'s probably more stuff I've added or changed but I forgot lol. ", isNew: true});
