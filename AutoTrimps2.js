...
function initializeAutoTrimps() {
    ...
    debug('AutoTrimps - ZekBeta Fork Loaded!', '*spinner3');
}

var changelogList = [];
changelogList.push({date: "20/02/2020", version: "v4.3.0", description: "<b>v5.3.0</b> Added Arch. Fixed bugs. Updated calc. ", isNew: true});
