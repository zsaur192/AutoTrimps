...
var changelogList = [];
changelogList.push({date: "08/08/2018", version: "v2.5.1", description: "It\'s been a while. Added Amal boost and reconfigured golden upgrades, i think you\'ll like it. 550+ Ratio is still being worked on (not that any of you will use it anyway lol) There\'s probably some other fixes and stuff aswell. More C2 specific stuff on its way, see you till next update! ", isNew: true});
...
//Extra
    ...
    if (getPageSetting('fightforever')==true || (getPageSetting('cfightforever')==true && (game.global.challengeActive == 'Toxicity' || game.global.challengeActive == 'Nom'))) fightalways();
