...
changelogList.push({date: "02/07/2018", version: "v2.3.3", description: "Daily settings may have some bugs, so please report them to me. Using h/hr% autoportal is not recommended (because it sucks). Added a max windstack setting for yah, enjoy. There might be some other things but I forgot (I do too many updates honestly). ", isNew: true});
