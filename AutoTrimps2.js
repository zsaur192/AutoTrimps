...
//Extra
    ...
    if (getPageSetting('loomswap') == true && getPageSetting('highdmg') != undefined && getPageSetting('lowdmg') != undefined && getPageSetting('loomswaphd') > 0 && game.world.zone >= getPageSetting('loomswap') && getEmpowerment() == "Wind") heirloomSwapping();
