...
function mainLoop() {
    ...
    if (getPageSetting('BuyArmorNew')==0);                                                //"Buy Neither"              (Equipment.js)
      else if (getPageSetting('BuyArmorNew')==1) BuyArmorUpgrades() && BuyArmor();        //"Buy Prestiges & Levels"   (")
      else if (getPageSetting('BuyArmorNew')==2) BuyArmorUpgrades();                      //"Buy Prestiges"            (")
      else if (getPageSetting('BuyArmorNew')==3) BuyArmor();                              //"Buy Levels"               (")
    if (getPageSetting('BuyWeaponsNew')==0);                                            //"Buy Neither"              (Equipment.js)
      else if (getPageSetting('BuyWeaponsNew')==1) BuyWeaponUpgrades() && BuyWeapons(); //"Buy Prestiges & Levels"   (")
      else if (getPageSetting('BuyWeaponsNew')==2) BuyWeaponUpgrades();                 //"Buy Prestiges"            (")
      else if (getPageSetting('BuyWeaponsNew')==3) BuyWeapons();                        //"Buy Levels"               (")
//    if (getPageSetting('PrestigeSkip1_2')==0);                                            //"Off"              (Equipment.js)
//      else if (getPageSetting('PrestigeSkip1_2')==1) BuyWeaponUpgrades() && BuyWeapons(); //"Prestige Skip 1+2"   (")
//      else if (getPageSetting('PrestigeSkip1_2')==2) BuyWeaponUpgrades();                 //"Prestige Skip 1"            (")
//      else if (getPageSetting('PrestigeSkip1_2')==3) BuyWeapons();                        //"Prestige Skip 2"               (")
