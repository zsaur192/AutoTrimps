...
var changelogList = [];
changelogList.push({date: "16/08/2018", version: "v2.5.3", description: "New <b>Magma</b> settings overhaul, it should be easier to understand now. Make sure they\'re set properly. Please let me know if something doesn\'t work with it. There\'s probably more stuff I've added or changed but I forgot lol. ", isNew: true});
