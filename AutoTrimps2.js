...
var changelogList = [];
changelogList.push({date: "15/01/2019", version: "v3.0.1", description: "<b>4.10.3</b> New Windstacking stance, seems to work fine. Removed B stance, Heirloom swap settings, Heirloom HD from Non-Daily and Daily tabs. New Windstacking manages it for you. ", isNew: true});
...
function mainLoop() {
    ...
    if (getPageSetting('autonu') == true && getPageSetting('heirloomnu') != undefined) spendNu();
