...
//Original
    ...
    autoLevelEquipment();
    if ((getPageSetting('UseScryerStance')== true) || (game.global.mapsActive && getCurrentMapObject().location == "Void" && ((getPageSetting('scryvoidmaps') == true && game.global.challengeActive != "Daily") || (getPageSetting('dscryvoidmaps') == true && game.global.challengeActive == "Daily")))) useScryerStance();
