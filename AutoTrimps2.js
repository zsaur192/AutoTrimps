...
changelogList.push({date: "4/2", version: "v2.1.6.9b", description: "Multiple Settings Were Combined. AutoPerks code was changed but still functions the same, except a new algorithm to reduce the time to allocate for high helium players. Test new algo with MODULES[\"perks\"].useAlgo2=true; .You can also clear all perks then allocate and have it work now.  AutoMaps no longer considered as Lead challenge when in Chall^2. ", isNew: true});
