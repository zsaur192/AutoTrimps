...
//Could combine automaps and run unique maps into one 3 way toggle: Automaps on, Non-unique maps only, Automaps off.
    ...
    //Line3
    createSetting('VoidMaps', 'Void Maps', '<b>0 to disable</b> The zone at which you want all your void maps to be cleared inclusive of the zone you type. Runs them at Cell 93 by default, unless you set a decimal value indicating the cell (example: 187.75).', 'value', '0', null, "Maps");
    createSetting('RunNewVoidsUntilNew', 'New Voids Mod', '<b>0 to disable. Positive numbers are added to your Void Map zone. -1 for no cap.</b> This allows you to run new Void Maps obtained after your Void Map zone. The number you put in here will cap what zone new Void Maps will run at, inclusive of the zone you type. The number that you put in here will cap what zone new Void Maps will run at, inclusive of the zone you type. CAUTION: May severely slow you down by trying to do too-high level void maps. Default 0.', 'value', '0', null, 'Maps'); //Should replace the two below
