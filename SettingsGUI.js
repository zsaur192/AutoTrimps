...
//Combat
    ...
    createSetting('AutoStance', ['Auto Stance OFF', 'Auto Stance 1', 'Auto Stance 2', 'Auto Stance 3'], 'Automatically swap stances to avoid death. The decision between AutoStance 1 or 2 is up to your own discretion and they should be similar. Better Autofight 3 is new and experimental for use after nature (z230)', 'multitoggle', 1, null, "Combat");
