...
//Daily
    ...
    createSetting('use3daily', 'Use AS3 for Daily', '<b> This must be on for Daily windstacking settings to appear!</> Overrides your Autostance settings to use AS3 on Dailys. Make sure to set your windstacking settings in Combat! (AS3 needs to be selected for them to appear, once selected you can switch back)', 'boolean', false, null, 'Daily');
