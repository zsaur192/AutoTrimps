...
function initializeAllSettings() {
    ...
    createSetting('Rtimemaplevel', 'TF: Map Level', '<b>DO NOT USE ITS BROKEN THIS IS YOUR ONLY WARNING!!!</b><br><br>What map level to use. Can use -1,1,2. -1 to use a level down from world, 0 to use world level, +1 etc to use +maps. Using 0 by itself will use global level for all maps. ', 'multiValue', [0], null, 'Maps');
