...
function initializeAllSettings() {
    ...
    createSetting('AutoStanceWind', 'Beta Windstacking', 'Turn this and Windstacking Stance On, and heirloom swapping to off (after defining heirloom names) to experience Windstacking beta. Obviously in heavy testing. ', 'boolean', false, null, "Combat");
