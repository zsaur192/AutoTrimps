...
//Combat
    ...
    createSetting('WindStacking', 'Windstack Min Zone', '<b>-1 = off, 0 = Always On</b><br>For use with AutoStance 3, enables windstacking in zones above and inclusive of the zone set. (Get 200 windstacks then change to D, kill bad guy, then repeat)', 'value', '0', null, 'Combat');
