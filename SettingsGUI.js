...
function initializeAllSettings() {
    ...
    createSetting('AutoStanceWind', 'Beta Windstacking', 'Turn this and Windstacking Stance On to experience Windstacking beta. Obviously in heavy testing. ', 'boolean', false, null, "Combat");
