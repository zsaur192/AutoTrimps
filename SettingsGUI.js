...
//Combat
    ...
    createSetting('WindStacking', 'Stack Wind Zones', 'For use with AutoStance 3, enables windstacking (Get 200 windstacks then change to D, kill bad guy, then repeat)', 'boolean', false, null, 'Combat');
