...
function initializeAllSettings() {
    ...
    createSetting('Rtimemaplevel', 'TF: Map Level', 'What map level to use. Can use -1,1,2. -1 or 0 to use a level down from world (Map Reducer mastery gives loot equal to world one level down), +1 etc to use +maps. Using 0 by itself will use global minus 1 level for all maps. ', 'multiValue', [0], null, 'Maps');
