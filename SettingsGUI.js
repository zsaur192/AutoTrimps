...
//GEAR:
    ...
    createSetting('gearamounttobuy', 'Gear Levels to Buy', 'Set the amount of Gear Levels to buy for AT. I.e if set to 1 will buy 1 level at a time. Recommended value 1. <b>MUST ALWAYS HAVE A VALUE GREATER THAN 1! </b>', 'value', 1, null, "Gear");
...
//Combat
    ...
    createSetting('WindStackingMax', 'Windstack Max', 'For use with AutoStance 3. Amount of windstacks to obtain before switching to D stance. Default is 200, but I recommend anywhere between 25-50. ', 'value', '-1', null, 'Combat');
    ...
    createSetting('ForceAbandon', 'Auto Force-Abandon', '(Trimpicide). If a new fight group is available and anticipation stacks aren\'t maxed, force abandon and grab a new group. Will not abandon in spire. Recommended ON. ', 'boolean', true, null, 'Combat');
