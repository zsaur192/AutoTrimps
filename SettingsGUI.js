...
//Daily
    ...
    createSetting('use3daily', 'Use AS3 for Daily', '<b> This must be on for Daily windstacking settings to appear!</b> Overrides your Autostance settings to use AS3 on Dailys. Make sure to set your windstacking settings in Combat! (AS3 needs to be selected for them to appear, once selected you can switch back)', 'boolean', false, null, 'Daily');
    ...
    createSetting('dhardcorewindmax', 'Daily Hardcore Windstacking Max', 'Max zone to finish hardcore windstacking in Dailys. I.e If you started Hardcore Windstacking at 526 and want to finish at 530, set this to 530. The next wind zone will not hardcore windstack. Use -1 or a really high value to hardcore windstack endlessly. ', 'value', '-1', null, 'Daily');
    createSetting('dfightforever', 'Daily Fight Always', 'Sends trimps to fight if they\'re not fighting in Daily challenges similar to Toxicity/Nom but not on Empower Dailys, regardless of BAF. Essenitally the same as the one in combat, can use either if you wish, except this will only activate in these daily challenges (duh) ', 'boolean', 'false', null, 'Daily');
...
//Combat
    ...
    createSetting('hardcorewindmax', 'Hardcore Windstacking Max', 'Max zone to finish hardcore windstacking. I.e If you started Hardcore Windstacking at 526 and want to finish at 530, set this to 530. The next wind zone will not hardcore windstack. Use -1 or a really high value to hardcore windstack endlessly. ', 'value', '-1', null, 'Combat');
...
// Dimensional Generator
    ...
    createSetting('fuellater', 'Start Fuel Z', 'Start fueling at thiz zone instead of 230. I would suggest you have a value lower than your max, for obvious reasons. Recommend starting at 300 and end fueling at 350. ', 'value', -1, null, 'Magma');
