...
//Maps
    ...
    createSetting('mapcutoff', 'Map Stacks H:D', 'If H:D goes over this value, It will get map stacks. The higher this setting, the less maps it will want to do. Default is 4. Must always have a value, if it does not, it won\'t work as intended. ', 'value', 4, null, 'Maps');
