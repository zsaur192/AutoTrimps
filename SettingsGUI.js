...
//CORE:
    ...
    createSetting('amalcoordt', 'Amal Target', '<b>NOT CURRENTLY WORKING! </b>Set the amount of Amals you wish to aim for. Once this target is reached, it will buy coords below your Amal ratio regardless of your H:D, just enough to keep the Amal. -1 to disable and use H:D for entire boost. ', 'value', -1, null, "Core");
...
//Spire
    ...
    createSetting('SpireBreedTimer', 'Spire Breed Timer', 'Uses Vanilla GA. When spire is active, will automatically change your GA to your <b>3RD OPTION!</b> Please use the 1st or 2nd GA option for normal behaviour if you intend to use this function properly. ', 'boolean', false, null, 'Spire');
