...
//Combat
    ...
    createSetting('WindStackingMin', 'Windstack Min Zone', '<b>-1 = off, 0 = Always On</b><br>For use with AutoStance 3, enables windstacking in zones above and inclusive of the zone set. (Get 200 windstacks then change to D, kill bad guy, then repeat)', 'value', '-1', null, 'Combat');
...
//Scryer
    ...
    createSetting('ScryUseinPoison', 'Scry in Poison','<b>-1 to disable</b>, any other number sets a minimum zone to use S in Poison', 'value', -1, null, 'Scryer'); //should it override Overkill??? Copy this for Wind/Ice
    createSetting('ScryUseinWind', 'Scry in Wind','<b>-1 to disable</b>, any other number sets a minimum zone to use S in Wind', 'value', -1, null, 'Scryer');
    createSetting('ScryUseinIce', 'Scry in Ice','<b>-1 to disable</b>, any other number sets a minimum zone to use S in Ice', 'value', -1, null, 'Scryer');
