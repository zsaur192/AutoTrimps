...
//Magma
    ...
    createSetting('spendmagmitesetting', ['Normal', 'Normal/No OC', 'OneTime/No OC', 'OneTime/OC'], '<b>Normal:</b> Spends Magmite Normally as Explained in \"Magmite spending behaviour\". <br><b>Normal/No OC:</b> Same as normal, except skips OC afterbuying 1 OC upgrade. <br><b>OneTime Only:</b> Only Buys the One off upgrades except skips OC afterbuying 1 OC upgrade. <br><b>OneTime/OC:</b> Buys all One off upgrades, then buys OC only. ', 'multitoggle', 0, null, 'Magma');
