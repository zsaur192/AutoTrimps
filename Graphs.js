...
function setGraphData(graph) {
    ...
    switch (graph) {
        ...
        case 'Wind Stacks':
            ...
            break;
        case 'Helium Sp':
            graphData = allPurposeGraph('sphehr', true, "number");
            title = 'Sp+ He/Hr';
            xTitle = 'Zone';
            yTitle = 'He/Hr';
            yType = 'Linear';
