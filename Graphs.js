...
function addGraphNoteLabel(){debug("GOTCHA This feature is not actually written, yet...")}
...
function pushData(){debug("Starting Zone "+game.global.world,"graphs");var a=100*(game.stats.heliumHour.value()/(game.global.totalHeliumEarned-(game.global.heliumLeftover+game.resources.helium.owned))),b=100*(game.resources.helium.owned/(game.global.totalHeliumEarned-game.resources.helium.owned));allSaveData.push({totalPortals:game.global.totalPortals,heliumOwned:game.resources.helium.owned,currentTime:new Date().getTime(),portalTime:game.global.portalTime,world:game.global.world,challenge:game.global.challengeActive,voids:game.global.totalVoidMaps,heirlooms:{value:game.stats.totalHeirlooms.value,valueTotal:game.stats.totalHeirlooms.valueTotal},nullifium:recycleAllExtraHeirlooms(!0),coord:game.upgrades.Coordination.done,essence:getTotalDarkEssenceCount(),hehr:a.toFixed(4),helife:b.toFixed(4),overkill:GraphsVars.OVKcellsInWorld,zonetime:GraphsVars.ZoneStartTime,mapbonus:GraphsVars.MapBonus,magmite:game.global.magmite,magmamancers:game.jobs.Magmamancer.owned,fluffy:game.global.fluffyExp,nursery:game.buildings.Nursery.purchased,amals:game.jobs.Amalgamator.owned,poprat:(game.resources.trimps.realMax()/game.resources.trimps.getCurrentSend()),runestones:playerSpire.getRsPs(),windstacks:game.empowerments.Wind.currentDebuffPower}),clearData(15),safeSetItems("allSaveData",JSON.stringify(allSaveData))}
var graphAnal=[];
...
function setGraphData(graph) {
    ...
    switch (graph) {
        ...
        case 'Dark Essence PerHour':
            ...
            xminFloor = 181;
            break;
        case 'Runestones-Second':
            graphData = allPurposeGraph('runestones', true, "number");
            title = 'Runestones/Second';
            xTitle = 'Zone';
            yTitle = 'Runestones/Second';
            yType = 'Linear';
            yminFloor = 0;
            precision = 2;
            break;
        ...
        case 'Amalgamators':
            ...
            break;
        case 'Pop Ratio':
            graphData = allPurposeGraph('poprat', true, "number");
